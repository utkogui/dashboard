...
app.post('/api/auth/impersonate', verificarSessao, async (req, res) => {
    try {
...
app.post('/api/client-actions/interest', verificarSessao, async (req, res) => {
    try {
...
app.get('/api/client-actions', verificarSessao, async (req, res) => {
    try {
        const { contratoId, profissionalId } = req.query;
        const usuario = req.usuario;
        const whereClause = {};
        if (contratoId)
...
app.post('/api/notes', verificarSessao, async (req, res) => {
    try {
...
app.get('/api/notes', verificarSessao, async (req, res) => {
    try {
        const { contratoId, profissionalId } = req.query;
        const usuario = req.usuario;
        const whereClause = {};
...
app.post('/api/requests/new-professional', verificarSessao, async (req, res) => {
    try {
...
app.get('/api/allocations/history', verificarSessao, async (req, res) => {
    try {
