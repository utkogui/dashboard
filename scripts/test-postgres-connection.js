/**
 * Script para testar a conexão com o banco de dados PostgreSQL (Supabase ou Neon)
 * 
 * Este script testa a conexão com o banco de dados PostgreSQL configurado no arquivo .env
